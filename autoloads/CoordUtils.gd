...
func world_to_chunk(w: Vector2i) -> Vector2i:
...
func world_to_local(w: Vector2i) -> Vector2i:
...
func chunk_local_to_world(chunk: Vector2i, local: Vector2i) -> Vector2i:
...
func make_crdt_key(layer: int, lx: int, ly: int) -> int:
